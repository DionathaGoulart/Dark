-- ============================================
-- Migration: Configurar políticas de Storage para Portfolio
-- ============================================
-- Este script configura as políticas RLS para o bucket portfolio-assets
-- Execute este script APÓS criar o bucket portfolio-assets no Supabase Storage
-- Data: 2024

-- IMPORTANTE: Certifique-se de que o bucket 'portfolio-assets' foi criado antes de executar este script
...
DROP POLICY IF EXISTS "Authenticated users can upload to portfolio-assets" ON storage.objects;
