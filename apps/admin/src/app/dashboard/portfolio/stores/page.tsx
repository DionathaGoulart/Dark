        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-primary-black/70 dark:text-primary-white/70">
              Edite o conteúdo da página Stores em Português e Inglês
            </p>
          </div>
          <button
            onClick={handleSave}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={10}
                  className="w-full px-4 py-2 border-2 border-primary-black dark:border-primary-white rounded bg-transparent text-primary-black dark:text-primary-white"
                  placeholder="Escreva o conteúdo da página Stores em português..."
                />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={10}
                  className="w-full px-4 py-2 border-2 border-primary-black dark:border-primary-white rounded bg-transparent text-primary-black dark:text-primary-white"
                  placeholder="Write the Stores page content in English..."
                />
              </div>
            </div>
          </div>
